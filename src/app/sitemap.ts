...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes = [
    ...
    { path: "/tools/compress-to-50kb", priority: 0.9, freq: "weekly" as const },
    { path: "/tools/compress-to-100kb", priority: 0.9, freq: "weekly" as const },
    { path: "/tools/compress-to-20kb", priority: 0.9, freq: "weekly" as const },
    { path: "/tools/passport-photo-maker", priority: 0.9, freq: "weekly" as const },
    { path: "/tools/unblur-image", priority: 0.9, freq: "weekly" as const },
    { path: "/tools/jpg-to-pdf", priority: 0.9, freq: "weekly" as const },
    { path: "/tools/pdf-to-jpg", priority: 0.9, freq: "weekly" as const },
    { path: "/tools/png-to-jpg", priority: 0.9, freq: "weekly" as const },
    { path: "/tools/jpg-to-png", priority: 0.9, freq: "weekly" as const },
    { path: "/tools/webp-to-jpg", priority: 0.9, freq: "weekly" as const },
    { path: "/tools/circle-crop", priority: 0.9, freq: "weekly" as const },
    { path: "/tools/flip-image", priority: 0.9, freq: "weekly" as const },
